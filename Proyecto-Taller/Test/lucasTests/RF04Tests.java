...
public class RF04Tests {
	...
	public void diaHace() {
		/*
		 * Assert.assertEquals("@delucas fue sábado 31 de marzo de 2018",
		 * ada.escuchar("@ada qué día fue ayer?"));
		 * 
		 * Assert.assertEquals("@delucas fue jueves 29 de marzo de 2018",
	...
	public void tiempoDesde() {
		/*
		 * Assert.
		 * assertEquals("@delucas entre el 1 de abril de 2017 y el 1 de abril de 2018 pasaron 365 días"
