...
public class RF10Tests {
	...
	public void adivinando() {
		Assert.assertEquals(
				...
				ada.escuchar("@ada jugamos?")
			);
		
		Assert.assertEquals(
				"@delucas ¿es el 50?",
				ada.escuchar("@ada listo")
			);
		
		Assert.assertEquals(
				"@delucas ¿es el 75?",
				ada.escuchar("@ada más grande")
			);
		
		Assert.assertEquals(
				"@delucas ¿es el 62?",
				ada.escuchar("@ada más chico")
			);
	...
	public void pensandoNumero() {
		Assert.assertEquals(
				"@delucas ¡listo!",
				ada.escuchar("@ada jugamos? Pensá un número del 1 al 100")
			);
		
		Assert.assertEquals(
				"@delucas más chico",
				ada.escuchar("@ada es el 50?")
			);
		
		Assert.assertEquals(
				"@delucas ¡si! Adivinaste en 2 pasos...",
				ada.escuchar("@ada es el 12?")
			);
